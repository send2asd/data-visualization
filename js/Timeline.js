...
function updateTimeline(country) {
    ...
    var totalHeightAvailable = height - margin.top - margin.bottom - 35; 
    var spacing = Math.max(totalHeightAvailable / events.length, 35); 

    
    var lastY = margin.top; 
    ...
    var yAxisGroup = svg.selectAll(".y-axis").data([0]); 
    ...
    svg.selectAll(".event-text")
        ...
        .attr("y", function(d) { return d.y + 4; })
        .text(function(d) { return d.event; })
        .call(wrapText, width - margin.right - 10); 
